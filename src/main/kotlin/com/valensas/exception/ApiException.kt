...
open class Continue(
    message: String,
    code: String = "CONTINUE",
    data: HashMap<*, *>? = null
) : ApiException(message, code, data)

@ResponseStatus(HttpStatus.SWITCHING_PROTOCOLS)
open class SwitchingProtocols(
    message: String,
    code: String = "SWITCHING_PROTOCOLS",
    data: HashMap<*, *>? = null
) : ApiException(message, code, data)
...
open class NonAuthoritativeInformation(
    message: String,
    code: String = "NON_AUTHORITATIVE_INFORMATION",
    data: HashMap<*, *>? = null
) : ApiException(message, code, data)

@ResponseStatus(HttpStatus.NO_CONTENT)
open class NoContent(
    message: String,
...
open class ResetContent(
    message: String,
    code: String = "RESET_CONTENT",
    data: HashMap<*, *>? = null
) : ApiException(message, code, data)

@ResponseStatus(HttpStatus.PARTIAL_CONTENT)
open class PartialContent(
    message: String,
    code: String = "PARTIAL_CONTENT",
    data: HashMap<*, *>? = null
) : ApiException(message, code, data)

@ResponseStatus(HttpStatus.MULTI_STATUS)
open class MultiStatus(
    message: String,
    code: String = "MULTI_STATUS",
    data: HashMap<*, *>? = null
) : ApiException(message, code, data)

@ResponseStatus(HttpStatus.ALREADY_REPORTED)
open class AlreadyReported(
    message: String,
    code: String = "ALREADY_REPORTED",
    data: HashMap<*, *>? = null
) : ApiException(message, code, data)
...
open class MultipleChoices(
    message: String,
    code: String = "MULTIPLE_CHOICES",
    data: HashMap<*, *>? = null
) : ApiException(message, code, data)

@ResponseStatus(HttpStatus.MOVED_PERMANENTLY)
open class MovedPermanently(
    message: String,
    code: String = "MOVED_PERMANENTLY",
    data: HashMap<*, *>? = null
) : ApiException(message, code, data)
...
open class NotModified(
    message: String,
    code: String = "NOT_MODIFIED",
    data: HashMap<*, *>? = null
) : ApiException(message, code, data)

@ResponseStatus(HttpStatus.TEMPORARY_REDIRECT)
open class TemporaryRedirect(
    message: String,
    code: String = "TEMPORARY_REDIRECT",
    data: HashMap<*, *>? = null
) : ApiException(message, code, data)

@ResponseStatus(HttpStatus.PERMANENT_REDIRECT)
open class PermanentRedirect(
    message: String,
    code: String = "PERMANENT_REDIRECT",
    data: HashMap<*, *>? = null
) : ApiException(message, code, data)
...
open class BandwidthLimitExceeded(
    message: String,
    code: String = "BANDWIDTH_LIMIT_EXCEEDED",
    data: HashMap<*, *>? = null
) : ApiException(message, code, data)
